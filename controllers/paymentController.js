...
export const buySubscription = catchAsyncError(async (req, res, next) => {
    ...
    const plan_id = process.env.PLAN_ID || "plan_NmxNPP6hnilZGh";
  ...
  export const getRazorPayKey = catchAsyncError(async(req,res,next)=>{
       res.status(200).json({
        success: true,
        key: process.env.RAZOR_API_SECRET,
       })
  })
  ...
  export const cancelSubscription = catchAsyncError(async(req,res,next)=>{
    ...
    //   }
      ...
      res.status(200).json({
        ...
        : "Subscription Cancelled , No Refund initiated as subscription was canncellled after 7 days"
       })
})
